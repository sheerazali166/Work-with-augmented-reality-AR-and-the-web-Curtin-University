...
//    }
    ...
    func updateSaveButtonState() {
        ...
        saveButton.isEnabled = !flagText.isEmpty && !countryText.isEmpty
        && !regionText.isEmpty && !populationText.isEmpty
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        var countryName = countryTextField.text ?? ""
        let region = regionTextField.text ?? ""
        let population = populationTextField.text ?? ""
        
        country = Country(flag: theFlag, name: countryName, region: region, population: population)
